...
public String listProducts(
    ...
    // SORT
    if ("asc".equals(sort)) {
        pageable = PageRequest.of(page, 5, org.springframework.data.domain.Sort.by("price").ascending());
    } 
    else if ("desc".equals(sort)) {
        pageable = PageRequest.of(page, 5, org.springframework.data.domain.Sort.by("price").descending());
    } 
    else {
